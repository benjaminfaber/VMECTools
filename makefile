...
NETCDF_F_INC_DIR = ${NETCDF_DIR}/include
NETCDF_F_LIB_DIR = ${NETCDF_DIR}/lib
NETCDF_C_INC_DIR = ${NETCDF_DIR}/include
NETCDF_C_LIB_DIR = ${NETCDF_DIR}/lib
...
F_LD_FLAGS := $(COMPILE_FLAGS) -L$(NETCDF_F_LIB_DIR) -L$(HDF5_LIB_DIR) -lnetcdff -lnetcdf -lhdf5_fortran -lhdf5
